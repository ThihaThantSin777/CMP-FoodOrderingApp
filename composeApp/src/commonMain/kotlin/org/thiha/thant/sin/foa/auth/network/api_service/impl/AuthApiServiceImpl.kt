...
object AuthApiServiceImpl : AuthApiService {
    ...
    override suspend fun forgetPasswordCheck(forgetPasswordRequestVO: ForgetPasswordRequestVO) {
    ...
    override suspend fun forgetPassword(forgetPasswordRequestVO: ForgetPasswordRequestVO) {
